...
{
    public class FormsAuthentication_bak
    {
        public FormsAuthentication_bak(DBAccess dB)
        {
            //dBAccess = dB;

        }
        public static void UpdateLoginInfo(ISession session, int UserCode, string UserName, string Password, string LoginDateTime, string ExpiryDateTime,
