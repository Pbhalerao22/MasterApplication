$(document).ready(function () {
    ...
    function LoadMasterOnLoad() {
        $('#gvMaster').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "/v2/Admin/SMSConfigMaster/GetSms",
                "type": "POST",
                "datatype": "json",
            ...
            "columns": [
                ...
                { "data": "SMS_CONTENT", "name": "SMS_Content", "autoWidth": true, "searchable": true },
                { "data": "OVERDUE_DATE", "name": "Overdue_Date", "autoWidth": true, "searchable": true },
                { "data": "NUMBER_OF_DAYS", "name": "Number_Of_Days", "autoWidth": true, "searchable": true },
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return '<a class="btn btn-outline-primary btn-sm mb-1" style="text-decoration:none" href="/v2/Admin/SMSConfigMaster/Edit?Code=' + data + '"  style="cursor: pointer;"><i class="fe fe-edit me-2"></i>Edit</a> ' +
    ...
    $('#gvMaster').on('click', '.MasterDelete', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/v2/Admin/SMSConfigMaster/Delete?Code=' + code;
