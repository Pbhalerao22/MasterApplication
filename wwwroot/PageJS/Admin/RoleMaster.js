$(document).ready(function () {
    ...
    function LoadMasterOnLoad() {
        $('#gvMaster').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "/v2/Admin/RoleMaster/GetRoles",
                "type": "POST",
                "datatype": "json",
                ...
                data: function (dtParms) {
                    ...
                    var JsonData = JSON.stringify(
                        {
                            draw: info.draw, PageNo: info.page, PageSize: info.length, SearchColumn: "ROLENAME", SearchValue: $("input[type='search']").val(),
                            SortColumn: "ROLENAME", SortType: "ASC"
                        });
                    return JsonData;
            ...
            "columns": [
                { "data": "ROLENAME", "name": "RoleName", "autoWidth": true, "searchable": false },
                { "data": "CODE", "name": "CODE", "autoWidth": true, "searchable": true },
                { "data": "ROLEDESCRIPTION", "name": "RoleDescription", "autoWidth": true, "searchable": true },
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return '<a class="btn btn-outline-primary btn-sm mb-1" style="text-decoration:none" href="/v2/Admin/RoleMaster/Edit?Code=' + data + '"  style="cursor: pointer;"><i class="fe fe-edit me-2"></i>Edit</a> ' +
    ...
    $('#gvMaster').on('click', '.MasterDelete', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '/v2/Admin/RoleMaster/Delete?Code=' + code;
